...
# 
# Original Author: Edward J Kim <edward.junhyung.kim@gmail.com>
#
# Modified by Samantha Thrush <thrush2@illinois.edu>
...
def run_parallel(filename, dest=None):
    ...
    for i in range(0, len(df)):
        ...
        try:
            ...
            saved = save_Xy(chunk, cat, image_dir=temp_dir, save_dir=target_dir)
